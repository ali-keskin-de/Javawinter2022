...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        // istersek java referans bilgisini yazdirir ( [I@58ceff1 )
        ...
        System.out.println(Arrays.toString(myArray));//[null, null, null, null]

        myArray[1]="Ali";
        myArray[3]="Halid";
        System.out.println(Arrays.toString(myArray));//[null, Ali, null, Halid]
